...
/* harmony import */ var src_app_shared_utilities_attachments_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/shared/utilities/attachments.service */ 15909);
/* harmony import */ var _services_image_uploader_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/image-uploader.service */ 36071);
...
let UserController = class UserController {
  constructor(auth, upload, images) {
    this.auth = auth;
    this.upload = upload;
    this.images = images;
    this.edit = false;
...
UserController.ctorParameters = () => [{
  ...
  type: _services_image_uploader_service__WEBPACK_IMPORTED_MODULE_3__.ImageUploaderService
}, {
  type: src_app_shared_utilities_attachments_service__WEBPACK_IMPORTED_MODULE_2__.AttachmentsService
}];

UserController = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Injectable)({
  providedIn: 'root'
})], UserController);
...
/* harmony import */ var src_app_shared_utilities_attachments_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/shared/utilities/attachments.service */ 15909);
...
/* harmony import */ var src_app_shared_utilities_push_notification_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/shared/utilities/push-notification.service */ 30250);
/* harmony import */ var _firestore_actions_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../firestore-actions.service */ 14871);
/* harmony import */ var _shared_utilities_my_store_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../shared/utilities/my-store.service */ 11308);
...
let FireAuthService = class FireAuthService {
  constructor(router, store, auth, FS, error, images, push) {
    var _this = this;
    ...
    return new Promise((resolve, reject) => {
      this.auth.createUserWithEmailAndPassword(email, password).then( /*#__PURE__*/function () {
        var _ref5 = (0,_Users_gabrielwitt_Desktop_UTPL_Practicum_4_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (userCredential) {
          ...
          yield _this5.upgradeUser('residente');

          _this5.uploadUserForm(user.uid, {
            uid: user.uid,
            photo: '',
            email: user.email,
            name,
            lastName,
            type: 'residente',
            createdAt: _this5.FS.returnNowStamp()
          }).then(done => {
            resolve(user);
          }).catch(error => {
  ...
  verifyEmail() {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref6 = (0,_Users_gabrielwitt_Desktop_UTPL_Practicum_4_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
  ...
  refreshUser() {
    ...
    return (0,_Users_gabrielwitt_Desktop_UTPL_Practicum_4_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return new Promise( /*#__PURE__*/function () {
        var _ref7 = (0,_Users_gabrielwitt_Desktop_UTPL_Practicum_4_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve) {
          try {
            _this7.store.readFile(_this7.credentials).then( /*#__PURE__*/function () {
              var _ref8 = (0,_Users_gabrielwitt_Desktop_UTPL_Practicum_4_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data) {
                console.log(data);

                if (data?.email && data?.password) {
                  _this7.login(data.email, data.password);

                  resolve(true);
                } else {
                  yield _this7.cleanSession();

                  _this7.router.navigateByUrl('general');
      ...
      try {
        _this8.signOut().then(() => {
          _this8.store.readFile(_this8.credentials).then( /*#__PURE__*/function () {
            var _ref9 = (0,_Users_gabrielwitt_Desktop_UTPL_Practicum_4_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data) {
              if (data.email && data.password) {
  ...
  updateUser(displayName, photoURL) {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref10 = (0,_Users_gabrielwitt_Desktop_UTPL_Practicum_4_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
        (yield _this9.auth.currentUser).updateProfile({
          displayName,
          photoURL
        }).then(() => {
          // Profile updated!
          ...
          reject(_this9.error.handle(error));
        });
      });
  ...
  upgradeUser(type) {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref11 = (0,_Users_gabrielwitt_Desktop_UTPL_Practicum_4_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
  ...
  signOut() {
    ...
    return new Promise((resolve, reject) => {
      this.auth.signOut().then( /*#__PURE__*/(0,_Users_gabrielwitt_Desktop_UTPL_Practicum_4_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        yield _this11.cleanSession();

        _this11.router.navigateByUrl('general'); // Sign-out successful.
  ...
  cleanSession() {
    ...
    return (0,_Users_gabrielwitt_Desktop_UTPL_Practicum_4_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield _this12.store.removeFile(_this12.session);
      yield _this12.store.removeFile(_this12.userInfo);
      yield _this12.store.removeFile(_this12.credentials);
      _this12.user = null;
      return null;
    })();
  } //DATA_ON_FIRESTORE
  ...
  uploadUserForm(uid, data) {
    ...
    return new Promise((resolve, reject) => {
      this.FS.setNamedDocument('users', uid, data).then( /*#__PURE__*/function () {
        var _ref13 = (0,_Users_gabrielwitt_Desktop_UTPL_Practicum_4_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (response) {
          if (_this13.user.uid === data.uid) {
            yield _this13.store.setData(_this13.userInfo, data);
          }
...
FireAuthService.ctorParameters = () => [{
  ...
  type: _shared_utilities_my_store_service__WEBPACK_IMPORTED_MODULE_5__.MyStoreService
}, {
  type: _angular_fire_compat_auth__WEBPACK_IMPORTED_MODULE_7__.AngularFireAuth
}, {
  type: _firestore_actions_service__WEBPACK_IMPORTED_MODULE_4__.FirestoreActionsService
}, {
  type: src_app_shared_utilities_error_handler_service__WEBPACK_IMPORTED_MODULE_2__.ErrorHandlerService
}, {
  type: src_app_shared_utilities_attachments_service__WEBPACK_IMPORTED_MODULE_1__.AttachmentsService
}, {
  type: src_app_shared_utilities_push_notification_service__WEBPACK_IMPORTED_MODULE_3__.PushNotificationService
}];

FireAuthService = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_9__.Injectable)({
  providedIn: 'root'
})], FireAuthService);
