(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["default-src_app_core_controller_user_controller_ts"],{

/***/ 82333:
/*!********************************************************!*\
  !*** ./src/app/core/controller/services.controller.ts ***!
  \********************************************************/
...
/* harmony import */ var _services_modules_maintenance_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/modules/maintenance.service */ 82227);
...
let ServicesController = class ServicesController {
  ...
  getServiceData(maintenance, serviceUID) {
    var _this2 = this;
    ...
    return (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (maintenance) {
        _this2.maintenanceList.forEach(service => {
          if (service.uid === serviceUID) {
            serviceData = service;
          }
        });
      } else {
        _this2.serviceList.forEach(service => {
          if (service.uid === serviceUID) {
            serviceData = service;
          }
        });
...
ServicesController.ctorParameters = () => [{
  type: _services_modules_maintenance_service__WEBPACK_IMPORTED_MODULE_1__.MaintenanceService
}];

ServicesController = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
  providedIn: 'root'
})], ServicesController);
...
/***/ 36046:
/*!****************************************************!*\
  !*** ./src/app/core/controller/user.controller.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let UserController = class UserController {
  ...
  changeProfileImage(image, uploading) {
    var _this = this;
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        this.upload.uploadFile('profile', imageName, image.file, progress => {
          ...
          this.auth.updateUser(this.currentUser.type, data.url).then( /*#__PURE__*/function () {
            var _ref = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (done) {
              const newUpdate = { ..._this.user,
                photo: data.url
              };
              yield _this.auth.uploadUserForm(_this.user.uid, newUpdate);
              _this.currentUser = newUpdate;
  ...
  updateUser(updatedData) {
    ...
    return new Promise((resolve, reject) => {
      try {
        this.auth.uploadUserForm(updatedData.uid, updatedData).then( /*#__PURE__*/function () {
          var _ref2 = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (done) {
            _this2.loadUser();
...
/* harmony import */ var src_app_shared_utilities_time_handler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/shared/utilities/time-handler */ 8123);
...
let FirestoreActionsService = class FirestoreActionsService {
    ...
    readCollectionOrderBy(folderName, field) {
        return new Promise((resolve, reject) => {
            try {
    ...
    readUserCollectionOrderFilter(folderName, filterName, filterValue, orderField, userUID, filterOperator) {
        return new Promise((resolve, reject) => {
            try {
                const filterOp = filterOperator ? filterOperator : '==';
                const callDoc = this.afs.collection(folderName, (ref => ref.where(filterName, filterOp, filterValue)
                    .where("userUID", "==", userUID).orderBy(orderField))).valueChanges();
                callDoc.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.take)(1)).subscribe((querySnapshot) => {
                    resolve(querySnapshot);
                });
            }
    ...
    setNamedDocument(folder, filename, data) {
        return new Promise((resolve, reject) => {
            data['updatedAt'] = this.time.dateTransform((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_0__.serverTimestamp)());
        ...
        return new Promise((resolve, reject) => {
            try {
                const callDoc = this.afs.collection('users', (ref => ref.where('email', '==', email)))
                    .valueChanges();
                callDoc.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.take)(1)).subscribe((data) => {
                    if (data.length > 0) {
                        resolve(data[0]);
                    }
                    else {
    ...
    readServicesOrderAll(folderName, communityUID) {
        return new Promise((resolve, reject) => {
            try {
    ...
    readServicesOrderFilter(folderName, communityUID, maintenance) {
        return new Promise((resolve, reject) => {
            try {
                const callDoc = this.afs.collection(folderName, (ref => ref
                    .where('communityUID', '==', communityUID)
    ...
    readServicesOrderFilterByType(folderName, communityUID, maintenance, serviceType, orderField) {
        return new Promise((resolve, reject) => {
            try {
                const callDoc = this.afs.collection(folderName, (ref => ref
                    .where('communityUID', '==', communityUID)
    ...
    readReceiptsByMonth(folderName, startMonth, endMonth) {
        return new Promise((resolve, reject) => {
            try {
                const callDoc = this.afs.collection(folderName, (ref => ref
...
FirestoreActionsService.ctorParameters = () => [
    ...
    { type: src_app_shared_utilities_time_handler__WEBPACK_IMPORTED_MODULE_2__.TimeHandlerModule },
    { type: _angular_fire_compat_firestore__WEBPACK_IMPORTED_MODULE_4__.AngularFirestore }
];
FirestoreActionsService = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
...
let ImageUploaderService = class ImageUploaderService {
  ...
  loadSaved() {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve) {
        try {
...
/* harmony import */ var src_app_shared_utilities_error_handler_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/shared/utilities/error-handler.service */ 43570);
/* harmony import */ var src_app_shared_utilities_push_notification_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/shared/utilities/push-notification.service */ 30250);
/* harmony import */ var _firestore_actions_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../firestore-actions.service */ 14871);
/* harmony import */ var _shared_utilities_my_store_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../shared/utilities/my-store.service */ 11308);
/* harmony import */ var src_app_shared_utilities_biometric_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/utilities/biometric.service */ 95735);
...
let FireAuthService = class FireAuthService {
  constructor(router, store, auth, FS, error, faio, push) {
    var _this = this;
    ...
    this.auth.authState.subscribe( /*#__PURE__*/function () {
      var _ref = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (userAuth) {
        if (userAuth) {
          ...
          _this.readUserForm(user.uid).then( /*#__PURE__*/function () {
            var _ref2 = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data) {
              if (!_this.user) {
                console.log(user);

                _this.push.registerPushService().then( /*#__PURE__*/function () {
                  var _ref3 = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (token) {
                    let userData = { ...data,
                      uid: user.uid,
                      email: user.email,
                      photo: user.photoURL,
                    ...
                    yield _this.uploadUserForm(userData.uid, userData);
          ...
          _this.store.removeFile('session');
  ...
  getUser() {
    ...
    return (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return new Promise((resolve, reject) => {
        try {
          _this2.store.readFile(_this2.session).then(session => {
            if (session) {
              _this2.store.readFile(_this2.userInfo).then(data => {
                resolve({
                  user: session,
                  data
                });
              ...
              _this2.router.navigateByUrl('general');
          ...
          if (data.user.emailVerified) {
            switch (data.user.displayName) {
              case 'administrador':
                ...
                if (currentModule !== route1) {
                  _this3.router.navigateByUrl(route1);
                }
              ...
              case 'residente':
                ...
                if (currentModule !== route2) {
                  _this3.router.navigateByUrl(route2);
                }
              ...
              case 'empleado':
                ...
                if (currentModule !== route3) {
                  _this3.router.navigateByUrl(route3);
                }

                break;

              default:
                _this3.router.navigateByUrl('client');

                break;
            }
          } else {
            _this3.router.navigateByUrl('general/verify-email/' + data.user.email);
          }
        } else {
          console.log('no user');
        }
  ...
  login(email, password) {
    ...
    return new Promise((resolve, reject) => {
      this.auth.signInWithEmailAndPassword(email, password).then( /*#__PURE__*/function () {
        var _ref4 = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (userCredential) {
          _this4.store.setData(_this4.credentials = 'credentials', {
            email,
            password
          });
  ...
  registerUser(email, password) {
    ...
    return new Promise((resolve, reject) => {
      this.auth.createUserWithEmailAndPassword(email, password).then( /*#__PURE__*/function () {
        var _ref5 = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (userCredential) {
          // Signed in 
          const user = userCredential.user;
          const userDataForm = yield _this5.FS.checkEmail(email);
          const updateUser = { ...userDataForm,
            uid: user.uid
          };
          ...
          _this5.uploadUserForm(user.uid, updateUser).then( /*#__PURE__*/function () {
            var _ref6 = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (done) {
              resolve(user);
            });
  ...
  verifyEmail() {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref7 = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
        (yield _this6.auth.currentUser).sendEmailVerification().then(() => {
  ...
  biometricsVerification() {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref8 = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
        if (_capacitor_core__WEBPACK_IMPORTED_MODULE_6__.Capacitor.getPlatform() !== 'web') {
          _this7.faio.isAvailable().then(result => {
            if (!!result) {
  ...
  refreshUser() {
    ...
    return (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return new Promise( /*#__PURE__*/function () {
        var _ref9 = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve) {
          try {
            _this8.store.readFile(_this8.credentials).then( /*#__PURE__*/function () {
              var _ref10 = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data) {
                if (data?.email && data?.password) {
                  _this8.biometricsVerification().then( /*#__PURE__*/function () {
                    var _ref11 = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (answer) {
                      if (answer) {
                        _this8.login(data.email, data.password);

                        resolve(true);
                      } else {
                        yield _this8.cleanSession();

                        _this8.signOut();

                        _this8.router.navigateByUrl('general');
  ...
  reCheckUser() {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref12 = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (Resolve, Reject) {
        try {
          _this9.store.readFile(_this9.credentials).then( /*#__PURE__*/function () {
            var _ref13 = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data) {
              _this9.auth.signOut().then( /*#__PURE__*/(0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
                setTimeout(() => {
                  if (data.email && data.password) {
  ...
  updateUser(displayName, photoURL) {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref15 = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
        (yield _this10.auth.currentUser).updateProfile({
          ...
          reject(_this10.error.handle(error));
        });
      });
  ...
  upgradeUser(type) {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref16 = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
        (yield _this11.auth.currentUser).updateProfile({
          ...
          reject(_this11.error.handle(error));
        });
      });
  ...
  signOut() {
    ...
    return new Promise((resolve, reject) => {
      this.auth.signOut().then( /*#__PURE__*/(0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        yield _this12.cleanSession();

        _this12.router.navigateByUrl('general'); // Sign-out successful.
  ...
  cleanSession() {
    ...
    return (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield _this13.store.removeFile(_this13.session);
      yield _this13.store.removeFile(_this13.userInfo);
      yield _this13.store.removeFile(_this13.credentials);
      _this13.user = null;
      return null;
    })();
  } //DATA_ON_FIRESTORE
  ...
  uploadUserForm(uid, data) {
    ...
    return new Promise((resolve, reject) => {
      this.FS.setNamedDocument('users', uid, data).then( /*#__PURE__*/function () {
        var _ref18 = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (response) {
...
FireAuthService.ctorParameters = () => [{
  ...
  type: _firestore_actions_service__WEBPACK_IMPORTED_MODULE_3__.FirestoreActionsService
}, {
  type: src_app_shared_utilities_error_handler_service__WEBPACK_IMPORTED_MODULE_1__.ErrorHandlerService
}, {
  type: src_app_shared_utilities_biometric_service__WEBPACK_IMPORTED_MODULE_5__.BiometricService
}, {
  type: src_app_shared_utilities_push_notification_service__WEBPACK_IMPORTED_MODULE_2__.PushNotificationService
}];

FireAuthService = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_10__.Injectable)({
  providedIn: 'root'
})], FireAuthService);
  ...
  updateUser(data) {
    return new Promise((resolve, reject) => {
      this.firestore.setNamedDocument(this.UsersFolder, data.uid, data).then( /*#__PURE__*/function () {
        var _ref = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (response) {
          resolve('done');
        });
...
/***/ 95735:
/*!*******************************************************!*\
  !*** ./src/app/shared/utilities/biometric.service.ts ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
BiometricService = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([
...
/* harmony import */ var _awesome_cordova_plugins_native_storage_ngx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @awesome-cordova-plugins/native-storage/ngx */ 20070);
...
let MyStoreService = class MyStoreService {
    ...
    return (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        ...
        if (_capacitor_core__WEBPACK_IMPORTED_MODULE_2__.Capacitor.getPlatform() !== 'web') {
          yield _this.nativeStorage.setItem(filename, {
            value: lockData
          });
        } else {
  ...
  readFile(filename) {
    ...
    return (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        if (_capacitor_core__WEBPACK_IMPORTED_MODULE_2__.Capacitor.getPlatform() !== 'web') {
          const saveData = yield _this2.nativeStorage.getItem(filename);
  ...
  removeFile(filename) {
    ...
    return (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        if (_capacitor_core__WEBPACK_IMPORTED_MODULE_2__.Capacitor.getPlatform() !== 'web') {
          yield _this3.nativeStorage.remove(filename);
        } else {
...
MyStoreService.ctorParameters = () => [{
  type: _awesome_cordova_plugins_native_storage_ngx__WEBPACK_IMPORTED_MODULE_1__.NativeStorage
}];

MyStoreService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Injectable)({
  providedIn: 'root'
})], MyStoreService);
...
/***/ 30250:
/*!***************************************************************!*\
  !*** ./src/app/shared/utilities/push-notification.service.ts ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _capacitor_push_notifications__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @capacitor/push-notifications */ 71704);
...
let PushNotificationService = class PushNotificationService {
  ...
  registerPushService() {
    return new Promise((resolve, reject) => {
      if (_capacitor_core__WEBPACK_IMPORTED_MODULE_1__.Capacitor.getPlatform() !== 'web') {
        _capacitor_push_notifications__WEBPACK_IMPORTED_MODULE_3__.PushNotifications.requestPermissions().then( /*#__PURE__*/function () {
          var _ref = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (result) {
  ...
  notificationFunctions() {
    ...
    return (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_capacitor_core__WEBPACK_IMPORTED_MODULE_1__.Capacitor.getPlatform() !== 'web') {
        ...
        _capacitor_local_notifications__WEBPACK_IMPORTED_MODULE_2__.LocalNotifications.addListener('localNotificationReceived', notification => {
          console.log('Notification: ' + JSON.stringify(notification));
          alert('Notification: ' + JSON.stringify(notification));
          console.log('pushNotificationRoutingDecision');
        });
        _capacitor_local_notifications__WEBPACK_IMPORTED_MODULE_2__.LocalNotifications.addListener('localNotificationActionPerformed', notification => {
          _this.cleanNotifications();
  ...
  cleanNotifications() {
    if (_capacitor_core__WEBPACK_IMPORTED_MODULE_1__.Capacitor.getPlatform() !== 'web') {
      _capacitor_push_notifications__WEBPACK_IMPORTED_MODULE_3__.PushNotifications.removeAllDeliveredNotifications();
    }
  }
...
PushNotificationService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Injectable)({
  providedIn: 'root'
...
/* harmony import */ var _alerts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./alerts */ 80884);





moment__WEBPACK_IMPORTED_MODULE_1__.locale('fr', {
...
let TimeHandlerModule = class TimeHandlerModule {
  constructor(alerts) {
    this.alerts = alerts;
    this.year = 'enero_febrero_marzo_abril_mayo_junio_juilio_agosto_septiembre_octubre_noviembre_diciembre'.split('_');
  }
  ...
  getShortDateUTC(date) {
    return moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(date).format('DD_MM_YYYY');
  }
  ...
  getScheduleList(scheduleDate, startTime, endTime, addTime) {
    return new Promise(resolve => {
      ...
      try {
        const endTimeSchedule = moment__WEBPACK_IMPORTED_MODULE_1__(moment__WEBPACK_IMPORTED_MODULE_1__(scheduleDate).format('MM/DD/YY') + ' ' + moment__WEBPACK_IMPORTED_MODULE_1__(endTime).format('HH:mm'), 'MM/DD/YY HH:mm');
        const currentTime = moment__WEBPACK_IMPORTED_MODULE_1__(moment__WEBPACK_IMPORTED_MODULE_1__(scheduleDate).format('MM/DD/YY') + ' ' + moment__WEBPACK_IMPORTED_MODULE_1__(startTime).format('HH:mm'), 'MM/DD/YY HH:mm');
        const LocalTime = {
          day: moment__WEBPACK_IMPORTED_MODULE_1__().format('MM/DD/YY'),
          hour: moment__WEBPACK_IMPORTED_MODULE_1__().format('HH'),
          minute: moment__WEBPACK_IMPORTED_MODULE_1__().format('mm')
        };

        while (currentTime.isBefore(endTimeSchedule)) {
          const newSlot = {
            date: currentTime.format('YYYY-MM-DDTHH:mm:ss.SSS') + 'Z',
            time: currentTime.format('h:mm A') + ' - ' + moment__WEBPACK_IMPORTED_MODULE_1__(currentTime).add(addTime, 'minutes').format('h:mm A'),
            disabled: moment__WEBPACK_IMPORTED_MODULE_1__(moment__WEBPACK_IMPORTED_MODULE_1__(currentTime).add(addTime, 'minutes')).isBefore(moment__WEBPACK_IMPORTED_MODULE_1__(LocalTime.day).set({
              hour: parseInt(LocalTime.hour),
              minute: parseInt(LocalTime.minute)
            })) ? true : false,
            selected: false,
            isFirst: moment__WEBPACK_IMPORTED_MODULE_1__(currentTime).isBefore(moment__WEBPACK_IMPORTED_MODULE_1__()) && list ? true : false
          };

          if (currentTime.add(addTime, 'minutes').isSameOrBefore(endTimeSchedule)) {
            list.push(newSlot);
          }
        }
    ...
    return new Promise(resolve => {
      try {
        if (timeSlotStart.date && timeSlotEnd.date && timeSlotStart.index !== timeSlotEnd.index) {
          ...
          timeSlotEnd = {
            hour: moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(timeSlot.date).add(timeToAdd, 'minutes').format('h:mm A'),
            date: moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(timeSlot.date).add(timeToAdd, 'minutes').toISOString(),
            index
          };
          ...
          if (timeSlot.date === timeSlotStart.date) {
          ...
          } else if (moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(timeSlot.date).isBefore(moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(timeSlotStart.date))) {
            scheduleTimes.forEach(slot => {
              slot.selected = false;
            });
            timeSlotStart = {
            ...
            timeSlot.selected = true;
            timeSlot.isFirstSelected = true;
          } else if (moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(timeSlot.date).isAfter(moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(timeSlotStart.date))) {
            const saved = timeSlotStart.index;
            let indexSelected = timeSlotStart.index;
            let countTwo = 0;

            while (moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(scheduleTimes[indexSelected].date).isBefore(moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(timeSlot.date))) {
              countTwo++;

              if (scheduleTimes[indexSelected].disabled) {
                this.alerts.showAlert('TIEMPO DE RESERVA', 'El tiempo seleccionado se cruza con otra reservación').then(back => {
                  scheduleTimes.forEach(slot => {
                    slot.selected = false;
                  });
                  timeSlotStart = {
                    hour: moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(scheduleTimes[saved].date).format('h:mm A'),
                    date: moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(scheduleTimes[saved].date).toISOString(),
                    index: scheduleTimes[saved].index
                  };
                  timeSlotEnd = {
                    hour: moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(scheduleTimes[saved].date).add(timeToAdd, 'minutes').format('h:mm A'),
                    date: moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(scheduleTimes[saved].date).add(timeToAdd, 'minutes').toISOString(),
                    index: scheduleTimes[saved].index
                  };
                ...
                indexSelected += 1;
                scheduleTimes[indexSelected].isFirstSelected = moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(scheduleTimes[indexSelected].date).isBefore(moment__WEBPACK_IMPORTED_MODULE_1__.parseZone()) && scheduleTimes || scheduleTimes[countTwo - 1].isFirstSelected !== true ? true : false;
              }
            }

            const end = moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(scheduleTimes[index].date).add(timeToAdd, 'minutes');
            let start = moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(timeSlotStart.date); // Repairs if date moves +1/-1 day because UTC transform
            // tslint:disable-next-line: radix

            start = moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(end.format('YYYY-MM-DD'), 'YYYY-MM-DD').set({
              h: parseInt(start.format('k')),
              m: parseInt(start.format('m'))
            });
            const diff = end.diff(start, 'minutes');

            if (maximumTime > 0 && diff > maximumTime) {
              this.alerts.showAlert('TIEMPO DE RESERVA', `El tiempo seleccionado excede el tiempo máximo de reserva (${this.maxTimeString(maximumTime)})`).then(back => {
                scheduleTimes.forEach(slot => {
                  slot.selected = false;
                });
                timeSlotStart = {
              ...
              timeSlotEnd = {
                hour: moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(scheduleTimes[index].date).add(timeToAdd, 'minutes').format('h:mm A'),
                date: moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(scheduleTimes[saved].date).add(timeToAdd, 'minutes').toISOString(),
                index: index + 1
              };
            }
  ...
  scheduleTimeElapsed(start, end) {
    const diff = moment__WEBPACK_IMPORTED_MODULE_1__(end).diff(moment__WEBPACK_IMPORTED_MODULE_1__(start), 'minutes');
    return this.maxTimeString(diff);
  }

  getStartHours(timeSlot) {
    return moment__WEBPACK_IMPORTED_MODULE_1__(timeSlot).format('h:mm A');
  }

  getEndHours(timeSlot, addTime) {
    return moment__WEBPACK_IMPORTED_MODULE_1__(timeSlot).add(addTime, 'minutes').format('h:mm A');
  }

  getStartDate() {
    return moment__WEBPACK_IMPORTED_MODULE_1__().hours(8).minutes(0).seconds(0).millisecond(0).toISOString();
  }

  getEndDate() {
    return moment__WEBPACK_IMPORTED_MODULE_1__().hours(18).minutes(0).seconds(0).millisecond(0).toISOString();
  }

  getCurrentMonthStart(date) {
    return moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(date).startOf('month').toISOString();
  }

  getEndMonth(date) {
    return moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(date).endOf('month').toISOString();
  }

  getNextMonStart(date) {
    return moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(date).add(1, 'months').toISOString();
  }

  getPrevMonStart(date) {
    return moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(date).subtract(1, 'months').toISOString();
  }

  getSelectedDate(date) {
    return moment__WEBPACK_IMPORTED_MODULE_1__(date).toISOString();
  }
...
TimeHandlerModule.ctorParameters = () => [{
  type: _alerts__WEBPACK_IMPORTED_MODULE_2__.AlertsService
}];

TimeHandlerModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Injectable)({
  providedIn: 'root'
})], TimeHandlerModule);
...
/* harmony export */ });
/* harmony import */ var _capacitor_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @capacitor/core */ 26549);
/* harmony import */ var _definitions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./definitions */ 46398);

const LocalNotifications = (0,_capacitor_core__WEBPACK_IMPORTED_MODULE_0__.registerPlugin)('LocalNotifications', {
  web: () => __webpack_require__.e(/*! import() */ "node_modules_capacitor_local-notifications_dist_esm_web_js").then(__webpack_require__.bind(__webpack_require__, /*! ./web */ 97671)).then(m => new m.LocalNotificationsWeb())
});
...
function _listAllHelper() {
  _listAllHelper = (0,_Users_gabrielwitt_Desktop_UTPL_Tesis_athosApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ref, accumulator, pageToken) {
    const opt = {
...
//# sourceMappingURL=default-src_app_core_controller_user_controller_ts.js.map