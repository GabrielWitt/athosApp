...
const routes = [
    ...
    {
        path: 'general',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_general_general_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/general/general.module */ 3387)).then(m => m.GeneralPageModule)
    },
];
